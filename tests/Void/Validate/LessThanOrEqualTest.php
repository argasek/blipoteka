...
/**
 * Less than or equal validator test case
 *
 * @author Jakub Argasiński <argasek@gmail.com>
 *
 */
class Void_Validate_LessThanOrEqualTest extends PHPUnit_Framework_TestCase {
	...
	public function testEquality() {
		$value = 5;
		$validator = new Void_Validate_LessThanOrEqual(5);
		$this->assertTrue($validator->isValid($value));
	}

	/**
	 * Greater value is considered invalid.
	 */
	...
	/**
	 * Lower value is considered valid.
	 */
