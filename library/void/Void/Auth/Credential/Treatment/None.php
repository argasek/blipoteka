...
/**
 * Authentication treatment using passtrough (i.e. doing nothing).
 *
 * @author Jakub Argasiński <argasek@gmail.com>
 */
class Void_Auth_Credential_Treatment_None implements Void_Auth_Credential_Treatment_Interface {
	/**
	 * Process credential.
