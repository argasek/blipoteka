...
/**
 * Authentication treatment using HMAC hash.
 *
 * @author Jakub Argasiński <argasek@gmail.com>
 */
class Void_Auth_Credential_Treatment_Hmac implements Void_Auth_Credential_Treatment_Interface {
	/**
	 ...
	 */
	public function __construct($key, $algorithm, $raw_output = false) {
	...
	public function treatment($credential) {
		return hash_hmac($this->_algorithm, $credential, $this->_key, $this->_raw_output);
	}
